...
// ========== Detect Variasi (TRUST checkbox + validate data) ==========
// Logic: kalau checkbox enable_variation di-uncheck oleh user, RESPECT itu
// (user mau ganti dari variasi ke harga biasa/grosir)
// Kalau checkbox checked, baru cek apakah data variasi valid
$hasVariation = false;
...
try {
    ...
    // Pakai $hasVariation yang udah di-compute (TRUST checkbox + validate data)
    // Variabel udah di-set di atas, sebelum validation
    if ($hasVariation) {
