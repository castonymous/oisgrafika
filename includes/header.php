...
<header class="navbar">
    <div class="nav-container">
        <div class="nav-top">
            ...
            <form action="<?= SITE_URL ?>/produk.php" method="GET" class="nav-search nav-search-desktop">
            ...
            <div class="nav-desktop-menu">
                <a href="<?= SITE_URL ?>/index.php" class="nav-link">Beranda</a>
                <a href="<?= SITE_URL ?>/produk.php" class="nav-link">Produk</a>
                <?php if ($currentUser): ?>
                    <a href="<?= SITE_URL ?>/keranjang.php" class="nav-icon-btn" aria-label="Keranjang">
                ...
                <?php else: ?>
                    <a href="<?= SITE_URL ?>/login.php" class="nav-link">Masuk</a>
                    <a href="<?= SITE_URL ?>/register.php" class="btn-nav-primary">Daftar</a>
                <?php endif; ?>
            </div>
        ...
        <form action="<?= SITE_URL ?>/produk.php" method="GET" class="nav-search nav-search-mobile">
            <input type="text" name="q" placeholder="Cari produk..." value="<?= clean($_GET['q'] ?? '') ?>">
            <button type="submit" aria-label="Cari">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                    <circle cx="11" cy="11" r="8"></circle>
    ...
    <aside class="mobile-drawer" id="navMenu">
        ...
        <ul class="drawer-links">
            <li><a href="<?= SITE_URL ?>/index.php"><span class="ico">🏠</span> Beranda</a></li>
            <li><a href="<?= SITE_URL ?>/produk.php"><span class="ico">🛍️</span> Produk</a></li>
            <?php if ($currentUser): ?>
                <li><a href="<?= SITE_URL ?>/dashboard.php"><span class="ico">📊</span> Dashboard</a></li>
                <li><a href="<?= SITE_URL ?>/dashboard.php?tab=orders"><span class="ico">📦</span> Pesanan Saya</a></li>
                <li><a href="<?= SITE_URL ?>/dashboard.php?tab=referral"><span class="ico">🎁</span> Program Referral</a></li>
                <?php if (isAdmin()): ?>
                ...
                <li><a href="<?= SITE_URL ?>/logout.php" class="link-danger"><span class="ico">🚪</span> Keluar</a></li>
            <?php else: ?>
                <li class="drawer-divider"></li>
                <li><a href="<?= SITE_URL ?>/login.php" class="drawer-btn drawer-btn-outline">Masuk</a></li>
                <li><a href="<?= SITE_URL ?>/register.php" class="drawer-btn drawer-btn-primary">Daftar Sekarang</a></li>
            <?php endif; ?>
        </ul>
    </aside>
</header>
